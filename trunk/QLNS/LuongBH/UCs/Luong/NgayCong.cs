    ...
    public partial class NgayCong : UserControl
    {
        ...
        private void btn_Them_Click(object sender, EventArgs e)
        {
                    ...
                    MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    int tu = Convert.ToInt32(dtp_TuThang.Value.Month.ToString() + dtp_TuThang.Value.Year.ToString());
                    int den = Convert.ToInt32(dtp_DenThang.Value.Month.ToString() + dtp_DenThang.Value.Year.ToString());
