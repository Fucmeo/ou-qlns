...
namespace HDQD.UCs
{
    public partial class QDChung : UserControl
    {
        ...
        {
            if (thongTinCNVC1.txt_MaNV.Text != "" && dtPhuCap.Rows.Count > 0)
                return true;
            else
                return false;
        }
        ...
        private void btn_Them_Click(object sender, EventArgs e)
        {
            if (CheckInputData())
            {
                ...
                foreach (DataRow dr in dtPhuCap.Rows)
                {
                    ...
                    #region Phu Cap Info
                    co_phu_cap.Add(Convert.ToBoolean(dr["co_phu_cap"].ToString()));
                ...
                try
                {
                    ...
                    {
                        if (oQuyetDinh.Add_QuyetDinhChung(Tham_Nien_Nang_Bac, Tham_Nien_Nha_Giao, Define_Cong_Thuc, Cong_Thuc, Phan_Tram_Cong_Thuc, Khong_Tinh_Luong,
