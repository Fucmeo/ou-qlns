...
{
    public class CNVC_QTr_CongTac_NonOU_NonGD
    {
        DataProvider.DataProvider dp;

        #region Init method

        public CNVC_QTr_CongTac_NonOU_NonGD()
        {
        ...
        public bool Delete()
        {
            ...
            check = (int)dp.executeScalarProc("sp_delete_cnvc_qtr_congtac_nonou_nongd", paras);
            if (check > 0)
            {
                return true;
            }
